...
const BraillePress = () => {
  ...
  const aimsAndObjectives = (
    <>
      ...
      <p>Reliance Drishti and Deepshika  are the Hindi magazines and Blind Welfare and White Print are the English magazines that the Press prints regularly. Around 4000 blind individuals/institutions for the Blind are receiving these magazines. These magazines are supplied free of cost or at very minimal price.  The subscription fee for these magazines are as under”</p>
      <ul>
          <li>Reliance Dristhi (Hindi)– free of cost (sponsored by Reliance Foundation) – Fortnightly.</li>
          <li>Deepshika (Hindi)– – Quarterly – Rs.30/- per annum (women Issues)</li>
          <li>Blind Welfare (English) – Three issues in a year – Rs.120/- per annum.</li>
          <li>White Print (Engish) – Editor- Upasana Makati</li>
          <li>Vingyan Bharati – a Science Magazine</li>
      </ul>
      ...
      <p>The Department has transcribed in braille “National Education Policy 2020” in English and Hindi.There are 600 general books in Braille are available in the center which are also supplied at concessional.  Catalogue of General Braille Books attached.</p>
  ...
  const committeeMembers = (
    <>
      <h4>Committee Members List 2022 – 2026</h4>
      <ul>
        <li><strong>Chairman:</strong> Dr. A.K. Sharma</li>
        <li><strong>Honorary Secretary In-Charge:</strong> Dr. Vimalkumar Dengla</li>
        <li><strong>Members:</strong></li>
        <ul>
          <li>Mr. Firdaus Adenwalla</li>
          <li>Ms.  Rashmi Amdekar</li>
          <li>Shri. Satej Dicholkar</li>
          <li>Ms. Vibhavari Savarkar</li>
          <li>Shri. Venkatesh Parab</li>
          <li>Ms. Neelam Sharma</li>
          <li>Shri. Pramod Singh</li>
        </ul>
  ...
  const contactInfo = (
    <>
        ...
        <h4>Donate Here:</h4>
        <ul>
            <li>A converted Braille Book – 500 pages  –    Rs.1,000/-</li>
            <li>Book Binding Material for 100 books   –      Rs.1,200/</li>
            <li>A Religious Book in Braille   –                      Rs.1,500/-</li>
            <li>Print Book to Braille Book Conversion  –     Rs.5,000/-</li>
            <li>120 Braille Pages Braille Book  for 50 copies  –    Rs.15,000/-    </li>
            <li>Automatic computer Braille Embosser 650 SW  –  Rs.90,00,000/-</li>
            <li>Braille Master Plate Embosser   –                          1,50,00,000/-</li>
        </ul>
    </>
  );
